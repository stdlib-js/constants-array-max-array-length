...
```javascript
MAX_ARRAY_LENGTH = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-array-max-array-length@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-array-max-array-length@v0.1.1-umd/browser.js"></script>
```
